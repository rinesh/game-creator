...
If the arguments or user request explicitly name KAPLAY, Kaplayground, Kaplayground WebMCP, or `rinesh/kaplayground`, stop this template pipeline and direct the user to the separate [Kaplayground plugin](https://github.com/rinesh/kaplayground/tree/kaplayground-plugin-v1.5.0/plugins/kaplayground). Do not claim a local `kaplay` skill or copy a Phaser template into a Kaplayground task.
